...
set(CMAKE_SYSROOT "${RELOCATED_HOST_DIR}/usr/aarch64-buildroot-linux-gnu/sysroot")
...
set(CMAKE_C_COMPILER "${RELOCATED_HOST_DIR}/usr/bin/aarch64-linux-gnu-gcc")
set(CMAKE_CXX_COMPILER "${RELOCATED_HOST_DIR}/usr/bin/aarch64-linux-gnu-g++")
if(1)
  ...
  set(CMAKE_Fortran_COMPILER "${RELOCATED_HOST_DIR}/usr/bin/aarch64-linux-gnu-gfortran")
endif()

...
am_rel_srcdir='.'
am_top_srcdir='/home/beyond2002/buildroot-2017.02.8/output/build/host-automake-1.15'
am_top_builddir='/home/beyond2002/buildroot-2017.02.8/output/build/host-automake-1.15'
...
case ${am_running_installcheck:=no} in
  yes)
    am_amdir='/home/beyond2002/buildroot-2017.02.8/output/host/usr/share/automake-1.15/am'
    am_automake_acdir='/home/beyond2002/buildroot-2017.02.8/output/host/usr/share/aclocal-1.15'
    am_bindir='/home/beyond2002/buildroot-2017.02.8/output/host/usr/bin'
    am_datadir='/home/beyond2002/buildroot-2017.02.8/output/host/usr/share'
    am_docdir='/home/beyond2002/buildroot-2017.02.8/output/host/usr/share/doc/automake'
    am_pkgvdatadir='/home/beyond2002/buildroot-2017.02.8/output/host/usr/share/automake-1.15'
    am_scriptdir='/home/beyond2002/buildroot-2017.02.8/output/host/usr/share/automake-1.15'
    am_system_acdir='/home/beyond2002/buildroot-2017.02.8/output/host/usr/share/aclocal'
    ;;
  no)
...
CFLAGS=${AM_TESTSUITE_CFLAGS-${CFLAGS-'-O2 -I/home/beyond2002/buildroot-2017.02.8/output/host/usr/include'}}
CXXFLAGS=${AM_TESTSUITE_CXXFLAGS-${CXXFLAGS-'-O2 -I/home/beyond2002/buildroot-2017.02.8/output/host/usr/include'}}
FCFLAGS=${AM_TESTSUITE_FCFLAGS-${FCFLAGS-''}}
FFLAGS=${AM_TESTSUITE_FFLAGS-${FFLAGS-''}}
CPPFLAGS=${AM_TESTSUITE_CPPFLAGS-${CPPFLAGS-'-I/home/beyond2002/buildroot-2017.02.8/output/host/usr/include'}}
...
GNU_CXXFLAGS=${AM_TESTSUITE_GNU_CXXFLAGS-${GNU_CXXFLAGS-'-O2 -I/home/beyond2002/buildroot-2017.02.8/output/host/usr/include'}}
GNU_CFLAGS=${AM_TESTSUITE_GNU_CFLAGS-${GNU_CFLAGS-'-O2 -I/home/beyond2002/buildroot-2017.02.8/output/host/usr/include'}}
